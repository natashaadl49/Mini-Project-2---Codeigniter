                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    ...
                                    <form method="post" action="<?php echo base_url('user/auth_user/proses_login_user') ?>" class="user">
                                        ...
                                        <a href="<?php echo base_url('administrator/auth/') ?>" class="btn btn-success btn-user btn-block">
                                            Ganti Login Admin
                                        </a>
                                    </form>
                                </div>
